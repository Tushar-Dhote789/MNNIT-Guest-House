...
public class tables
{
    public static void main(String[] args)
    {
        ...
        try
        {
            ...
            st.executeUpdate("create table room(roomNo varchar(10),bed varchar(200),price int, status varchar(20))");
           st.executeUpdate("create table student(id int,name varchar(200),mobileNumber varchar(20),nationality varchar(200),gender varchar(50),email varchar(200),idProof varchar(200),address varchar(500),checkIn varchar(50),roomNo varchar(10),bed varchar(200),pricePerDay int(10),numberOfDaysStay int(10),totalAmount varchar(200),checkOut varchar(50))");
